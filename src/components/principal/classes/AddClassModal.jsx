      ...
      <div className="bg-white w-full max-w-3xl mx-4 rounded-2xl shadow-2xl p-10 animate-fade-in transition-all duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base">
           <div>
            ...
            <input
              ...
              onChange={(e) => setClassData({...prev , class:e.target.value})}
          ...
          <div>
            ...
            <input
              ...
              className="w-full input"
              value={classData?.class}
              onChange={(e) => setClassData({...prev , level:e.target.value})}
           ...
           <div className="md:col-span-2">
            ...
            <div className="relative">
              <select
                ...
                value={role}
                onChange={(e) => setClassData({...prev,direction:e.target.value})}
              >
                {directions.map((r) => (
        ...
        <div className="flex justify-end gap-4 mt-10">
          ...
          <button
            ...
            >
              {buttonLoading ? <ClipLoader size={16} /> : 'Add Class'}
            </button>
        </div>
      </div>
    </div>
